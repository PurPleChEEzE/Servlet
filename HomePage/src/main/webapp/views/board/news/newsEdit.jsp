    ...
    <div class="card text-center" style="height: 100%">
        ...
        <div class="card-body">
            <div class="d-flex justify-content-center mb-3">
                ...
                <div class="mx-3">작성일: <span id="fb-date">2024-05-13</span></div>
                <div class="mx-3">조회수: <span id="fb-views">0</span></div>
            </div>
            <hr> 
            <textarea style="height:300px">내용</textarea>
        ...
        <div class="card-footer d-flex justify-content-center">
            ...
            <c:if test="${sessionScope.userNo == result.memberNo}">
	            <button class="btn btn-primary mx-2" onclick="editPost()">수정</button>
            </c:if>
        </div>
    </div>
</section>
